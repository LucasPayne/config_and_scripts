...
local user_opts = {
    ...
    fadeduration = 0,         -- duration of fade out (and fade in, if enabled) in ms, 0 = no fade
    ...
    top_buttons_color = "#000000",    -- color of top buttons
    held_element_color = "#333333",   -- color of an element while held down

    time_pos_outline_color = "#444444",   -- color of the border timecodes in slimbox and TimePosBar
