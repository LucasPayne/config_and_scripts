...
"     users to configure these low level details. So, to make vim work well with
"     any modern terminal, including kitty, add the following to your ~/.vimrc."
if &term == "xterm-kitty"
    " Mouse support
    set mouse=a
    set ttymouse=sgr
